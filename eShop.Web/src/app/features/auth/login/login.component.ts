...
@Component({
  ...
  template: `
    <div
      class="min-h-screen w-full flex bg-canvas text-primary transition-colors duration-300"
    >
      ...
      <div
        class="hidden lg:flex w-1/2 flex-col justify-between bg-surface border-r border-border p-12 transition-colors duration-300"
      >
        <div>
        ...
        <div
          class="flex-1 flex flex-col justify-center max-w-md mx-auto relative"
        >
          <div
            class="relative rounded-2xl overflow-hidden aspect-square border border-border shadow-soft bg-canvas flex items-center justify-center p-8 transition-colors duration-300"
          >
            <img
              src="Cu_Do_38.jpg"
              alt="Logo Cu Đơ 38"
              class="w-full h-full object-cover rounded-xl opacity-90 mix-blend-multiply dark:mix-blend-screen"
            />
          </div>
          <div class="mt-12 space-y-4">
            <h2 class="text-display-sans">Nguyễn Quang Vinh</h2>
      ...
      <div
        class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-24 relative"
      >
        <div class="w-full max-w-md space-y-12">
          <div class="space-y-3">
            <h1 class="text-h1">Chào mừng quay lại.</h1>
            <p class="text-body text-secondary">
              Vui lòng đăng nhập vào hệ thống để tiếp tục.
            </p>
          </div>
          ...
          >
            ...
            <div class="flex items-center justify-between">
              ...
              <a href="#" class="text-caption text-accent hover:underline"
                >Quên mật khẩu?</a
              >
            </div>
