    ...
    <nav class="shell-nav">
      <div class="page-shell shell-nav__inner">
        ...
        <a class="shell-nav__brand" routerLink="/">
          <!-- NQV SVG Mark: Navy + Gold brand identity -->
          <svg
            width="38"
            height="38"
            viewBox="0 0 44 44"
          ...
          <div class="shell-nav__brand-text">
            <span class="shell-nav__name">QUANG VINH</span>
            <span class="shell-nav__sub">NGUYỄN QUANG VINH</span>
          </div>
        </a>
        ...
        <div class="shell-nav__actions">
          ...
          <a
            routerLink="/cart"
            class="shell-nav__icon-btn relative"
            title="Giỏ hàng"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span
              *ngIf="totalItems() > 0"
              class="absolute top-1 right-0 bg-zinc-900 text-white text-[10px] font-bold h-4 min-w-[16px] px-1 rounded-full flex items-center justify-center translate-x-1 -translate-y-1 border-2 border-[#F9FAFB] shadow-sm"
            >
          ...
          <ng-container *ngIf="isLoggedIn(); else loginBtn">
            ...
            <button
              (click)="logout()"
              class="shell-nav__icon-btn logout-btn"
              title="Đăng xuất"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
