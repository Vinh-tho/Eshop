  ...
  template: `
    ...
    >
      <div class="flex flex-1 min-h-[100dvh] relative overflow-x-hidden">
        ...
        <aside
          [class]="
            'flex-shrink-0 flex flex-col fixed md:sticky top-0 h-[100dvh] overflow-y-auto px-4 py-6 transition-all duration-300 ease-in-out z-50 md:z-20 ' +
            (isMobileDrawerOpen()
        ...
        >
          ...
          <div class="flex items-center justify-between mb-8 px-1">
            <div class="flex items-center gap-3 overflow-hidden">
              ...
              >
                ...
                />
                <path
                  d="M7 31 L7 13 L16 23 L25 13 L25 31"
                  [attr.stroke]="isDark() ? '#FFFFFF' : '#0F3460'"
                  stroke-width="2.2"
                ...
                />
                <path
                  d="M29 17 Q38 17 38 24 Q38 31 29 31 L29 17"
                  stroke="#C9A961"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <div
                *ngIf="!isCollapsed() || isMobileDrawerOpen()"
                class="flex flex-col leading-none whitespace-nowrap transition-opacity duration-200"
              >
                <span
                  class="text-[13px] font-extrabold tracking-[0.15em] uppercase"
                  [style.color]="isDark() ? '#FFFFFF' : '#0F3460'"
                  >QUANG VINH</span
                >
                <span
                  class="text-[10px] tracking-[0.12em] font-semibold mt-1"
                  [style.color]="isDark() ? '#C9A961' : '#A88A3E'"
                  >ADMIN PANEL</span
                >
              </div>
            </div>
          ...
          <nav class="flex-1 flex flex-col gap-6">
            ...
            <div>
              <div
                *ngIf="!isCollapsed() || isMobileDrawerOpen()"
                class="text-[10px] font-bold uppercase tracking-widest mb-2.5 px-2 text-slate-400"
              >
                Tổng quan
              </div>
              <div
                *ngIf="isCollapsed() && !isMobileDrawerOpen()"
                class="w-full h-px my-2"
                [style.background]="
              ...
              <ul class="flex flex-col gap-1">
                <li *hasPermission="PERMISSIONS.DASHBOARD.VIEW">
                  <a
                    ...
                    [class]="
                      'flex items-center gap-3 py-2.5 rounded-xl text-[13px] font-medium transition-all duration-200 outline-none ' +
            ...
            <div>
              ...
              <ul class="flex flex-col gap-1">
                ...
                <li
                  *hasPermission="[
                    PERMISSIONS.IDENTITY.ROLES_VIEW,
                    PERMISSIONS.IDENTITY.ROLES_MANAGE,
                  ]"
                >
                  <a
                ...
                <li
                  *hasPermission="[
                    PERMISSIONS.IDENTITY.USERS_VIEW,
                    PERMISSIONS.IDENTITY.USERS_MANAGE,
                  ]"
                >
                  <a
          ...
          >
            ...
            <button
              (click)="toggleTheme()"
              [class]="
                'flex items-center gap-3 py-2.5 rounded-xl text-[13px] font-medium transition-all duration-200 outline-none cursor-pointer hover:bg-slate-500/10 text-left ' +
                (isCollapsed() && !isMobileDrawerOpen()
                  ? 'justify-center px-0'
                  : 'px-3')
              "
            >
              ...
              <span
                *ngIf="!isCollapsed() || isMobileDrawerOpen()"
                class="truncate"
                >{{ isDark() ? "Chế độ tối" : "Chế độ sáng" }}</span
              >
            </button>
            ...
            >
              <div
                class="w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center text-[11px] font-bold select-none shadow-sm"
              ...
              <div
                *ngIf="!isCollapsed() || isMobileDrawerOpen()"
                class="flex-1 flex flex-col leading-tight min-w-0"
              >
                <span
                  class="text-[13px] font-semibold truncate"
                  [style.color]="isDark() ? '#F1F5F9' : '#0F172A'"
                  >Nguyễn Quang Vinh</span
                >
                <span
        ...
        <div class="flex-1 flex flex-col min-w-0 h-[100dvh] overflow-y-auto">
          ...
          <header
            class="h-16 px-4 md:px-6 flex items-center justify-between sticky top-0 z-10 backdrop-blur-md transition-colors duration-300"
            [style.background]="
              isDark() ? 'rgba(17, 24, 39, 0.85)' : 'rgba(255, 255, 255, 0.85)'
            "
            [style.borderBottom]="
              isDark()
                ? '1px solid rgba(255,255,255,0.07)'
          ...
          >
            ...
            <div class="flex items-center gap-2 sm:gap-3">
              ...
              <span
                class="hidden md:inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-semibold tracking-wide border"
                [style.background]="
              ...
              <!-- Notification Bell -->
              <button
                class="relative p-2 rounded-xl transition-all duration-200 outline-none cursor-pointer border hover:bg-slate-500/10 text-slate-400"
                [style.borderColor]="
                  isDark() ? 'rgba(255,255,255,0.1)' : '#E2E8F0'
                "
                title="Thông báo"
              >
                ...
                <span
                  class="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-indigo-500"
                ></span>
              </button>
            </div>
          </header>
          ...
          <nav
            class="md:hidden fixed bottom-0 left-0 right-0 h-16 z-30 flex items-center justify-around px-2 backdrop-blur-lg border-t transition-colors duration-300"
            [style.background]="
