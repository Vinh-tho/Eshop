...
namespace CR.Core.Infrastructure.Persistence.Seeders
{
    public static class DataSeeder
    {
        public static async Task SeedAsync(CoreDbContext db)
        {
            ...
            // 2. Users
            if (!await db.Users.AnyAsync(u => u.Email == "nguyenvinh1242004@gmail.com"))
            {
                ...
                if (superAdminRole != null)
                {
                    var superAdminUser = new Users
                    {
                        ...
                        Email = "nguyenvinh1242004@gmail.com",
                        Phone = "0900000000",
                        ...
                        Profile = new UserProfile { FullName = "Nguyễn Quang Vinh", PhoneNumber = "0900000000", Gender = (CR.Constants.Core.Users.GenderTypes)1 },
